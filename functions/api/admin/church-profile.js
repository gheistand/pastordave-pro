...
export async function onRequestPatch({ request, env }) {
  ...
  const { logo_url, accent_color, display_name, weekly_bulletin, bulletin_url } = body;
  ...
  if (bulletin_url !== undefined) {
    updates.push('bulletin_url = ?');
    values.push(bulletin_url || null);
  }
